...
![Image showing an example of points, lines and polygons](media/open-vector1.jpeg)
...
![Screen recording of dragging the file into the QGIS program](media/open-vector1.gif)
