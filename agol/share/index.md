# How to configure an ArcGIS Online product for sharing

In order to publish **maps** you have created in ArcGIS Online in a StoryMap, the data source *and* web map must be shared as public, in order for the StoryMap to be shareable.
